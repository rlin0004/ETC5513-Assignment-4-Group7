...
```
An interesting trend to notice from Figure graph2 and summary-table is that the number of offences for age group below 45 decreased in 2018-2019, whils it increased for age group above 45.
